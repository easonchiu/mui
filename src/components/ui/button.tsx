  ...
  "group/button inline-flex shrink-0 items-center justify-center rounded-sm border border-transparent bg-clip-padding text-sm whitespace-nowrap transition-all outline-none select-none focus-visible:border-ring2 focus-visible:ring-2 focus-visible:ring-ring2 active:not-aria-[haspopup]:scale-[0.98] disabled:pointer-events-none aria-invalid:border-destructive aria-invalid:ring-2 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-3.5 [&:disabled:not([data-loading])]:opacity-50",
  {
    variants: {
      variant: {
        ...
        danger:
          "bg-red-700 text-white hover:bg-red-800 focus-visible:border-red-500 focus-visible:ring-red-500/10 dark:bg-red-700 dark:text-white dark:hover:bg-red-800 dark:focus-visible:ring-red-500/40",
