      ...
      >
        ...
        >
          ...
          <PreviewCardPrimitive.Arrow
            ...
            className="z-50 size-2.5 translate-y-[calc(-50%+0.5px)] rotate-45 rounded-none border-foreground/15 bg-popover data-[side=bottom]:-top-px data-[side=bottom]:rounded-tl-xs data-[side=bottom]:border-t data-[side=bottom]:border-l data-[side=inline-end]:top-1/2! data-[side=inline-end]:-left-1 data-[side=inline-end]:translate-x-[1.5px] data-[side=inline-end]:-translate-y-1/2 data-[side=inline-end]:rounded-bl-xs data-[side=inline-end]:border-b data-[side=inline-end]:border-l data-[side=inline-start]:top-1/2! data-[side=inline-start]:-right-1 data-[side=inline-start]:translate-x-[-1.5px] data-[side=inline-start]:-translate-y-1/2 data-[side=inline-start]:rounded-tr-xs data-[side=inline-start]:border-t data-[side=inline-start]:border-r data-[side=left]:top-1/2! data-[side=left]:-right-1 data-[side=left]:translate-x-[1.5px] data-[side=left]:-translate-y-1/2 data-[side=left]:rounded-tr-xs data-[side=left]:border-t data-[side=left]:border-r data-[side=right]:top-1/2! data-[side=right]:-left-1 data-[side=right]:translate-x-[-1.5px] data-[side=right]:-translate-y-1/2 data-[side=right]:rounded-bl-xs data-[side=right]:border-b data-[side=right]:border-l data-[side=top]:-bottom-2.5 data-[side=top]:rounded-br-xs data-[side=top]:border-r data-[side=top]:border-b data-[side=top]:border-foreground/25 dark:border-foreground/10"
          />
        </PreviewCardPrimitive.Popup>
      </PreviewCardPrimitive.Positioner>
