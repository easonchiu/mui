                ...
                {(value: Value, index: number) => {
                  ...
                  return (
                    <ComboboxPrimitive.Item
                      ...
                      className="relative flex w-full cursor-default items-center gap-2.5 rounded-xs py-2 pr-8 pl-3 text-sm outline-hidden select-none data-highlighted:bg-accent data-highlighted:text-accent-foreground data-disabled:pointer-events-none data-disabled:opacity-50 [&:not([data-disabled]):hover]:bg-accent [&:not([data-disabled]):hover]:text-accent-foreground"
                    >
